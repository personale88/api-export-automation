...
def search_facebook(keyword, max_results=5):
    ...
    results = list(FACEBOOK_MOCK_LEADS[:max_results])
    ...
    try:
        ...
        print(f"[Facebook Search] Found {len(results)} retail & boutique records for '{keyword}'.")
        return results
    except Exception as e:
        print(f"[Facebook Search] Live search notice: {e}. Returning curated dataset...")
        return results
